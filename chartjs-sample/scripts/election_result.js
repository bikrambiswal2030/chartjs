...
var barChart = new Chart(bar, {
    type: 'bar',
    data: {
      labels: ["BJP", "SHIVA SENA", "JDU", "LJP", "SAD", "AD(S)", "AJSU", "MNF", "RLTP", "AIDMK", "NDPP", "NPP", "CONGRESS", "DMK", "NCP", "IUML", "JKNC", "KCM", "RCP", "IND", "JMM", "VCK", "JDS", "TCP", "BJD", "BSP", "SP"],
      datasets: [{
        label: 'Sits Own in Indian Parliament',
        data: [303, 18, 16, 6, 2, 2, 1, 1, 1, 1, 1, 1, 52, 23, 5, 3, 3, 1, 1, 1, 1, 1, 1, 22, 12, 10, 5],
        backgroundColor: [
          '#f4c430',
          'red',
          'green',
...
var lineChart = new Chart(Line, {
  ...
  responsive: 'false',
  data: {
    labels: ["1984", "1989", "1991", "1996", "1998", "1999", "2004", "2009", "2014", "2019"],
    datasets: [{
